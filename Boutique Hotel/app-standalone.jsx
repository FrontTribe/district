...
const F = (id, fb) => R[id] || fb;
const IMG = {
  hero: F("hero", CDN + "_DSC8896.jpg"),
  about1: F("about1", CDN + "_DSC8812.jpg"),
  about2: F("about2", CDN + "_DSC8546-1024x683.jpg"),
  about3: F("about3", CDN + "_DSC8855.jpg"),
  rooftopHero: F("rooftopHero", CDN + "_DSC8530%20(1)%202-1920x1280.jpg"),
  contactHero: F("rooftopHero", CDN + "_DSC8530%20(1)%202-1920x1280.jpg"),
  rooftop: [
    F("rf0", CDN + "_DSC9307-480x320.jpg"),
    F("rf1", CDN + "_DSC9318-480x320.jpg"),
    F("rf2", CDN + "_DSC9340-480x320.jpg"),
    F("rf3", CDN + "DJI_20241207142535_0167_D-480x270.jpg"),
  ],
};
...
const ROOMS = [
  {
    ...
    images: [
      F("p0", CDN + "_DSC8926-1024x683.jpg"),
      F("p1", CDN + "_DSC8933-1024x683.jpg"),
      F("p2", CDN + "_DSC8981-1024x683.jpg"),
      F("p3", CDN + "_DSC9000-1024x682.jpg"),
      F("p4", CDN + "_DSC9003-1024x683.jpg"),
      F("p5", CDN + "_DSC9019-1024x682.jpg"),
    ],
  },
  {
    ...
    images: [
      F("d0", CDN + "_DSC8535-1024x682.jpg"),
      F("d1", CDN + "_DSC8546-1024x683.jpg"),
      F("d2", CDN + "_DSC8573-1024x683.jpg"),
      F("d3", CDN + "_DSC8956-1024x683.jpg"),
      F("d4", CDN + "_DSC8963-1024x683.jpg"),
      F("d5", CDN + "_DSC8969-1024x683.jpg"),
    ],
  },
  {
    ...
    images: [
      F("s0", CDN + "_DSC8819-1024x683.jpg"),
      F("s1", CDN + "_DSC8827-1024x683.jpg"),
      F("s2", CDN + "_DSC8863-1024x683.jpg"),
      F("s3", CDN + "_DSC8869-1024x683.jpg"),
      F("s4", CDN + "_DSC8871-1024x683.jpg"),
      F("s5", CDN + "_DSC8891-1024x683.jpg"),
    ],
  },
  {
    ...
    images: [
      F("j0", CDN + "_DSC8636-1024x683.jpg"),
      F("j1", CDN + "_DSC8640%20(1)-1024x683.jpg"),
      F("j2", CDN + "_DSC8654-1024x683.jpg"),
      F("j3", CDN + "_DSC8656-1024x683.jpg"),
      F("j4", CDN + "_DSC8660-1024x683.jpg"),
      F("j5", CDN + "_DSC8708-1024x683.jpg"),
    ],
  },
];
